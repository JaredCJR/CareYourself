...
$result = mysql_query("SELECT *FROM _messages_south where content LIKE '%".$keyword."%' OR title LIKE '%".$keyword."%'") or die(mysql_error());
}
else
{
// get all messages from _messages table
mysql_query("set names utf8");
$result = mysql_query("SELECT *FROM _messages_south") or die(mysql_error());
}
